...
<div style="height:400px; width:100%;">
  <canvas id="adolescentSleepShiftChart"></canvas>
</div>
...
<div style="height:400px; width:100%;">
  <canvas id="wakeWindowsChart"></canvas>
</div>
...
<div class="strawpoll-embed" id="strawpoll_PbZqbAXvNyN" style="height: 772px; max-width: 640px; width: 100%; margin: 0 auto; display: flex; flex-direction: column;"><iframe title="StrawPoll Embed" id="strawpoll_iframe_PbZqbAXvNyN" src="https://strawpoll.com/embed/PbZqbAXvNyN" style="position: static; visibility: visible; display: block; width: 100%; flex-grow: 1;" frameborder="0" allowfullscreen allowtransparency>Loading...</iframe><script async src="https://cdn.strawpoll.com/dist/widgets.js" charset="utf-8"></script></div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  new Chart(document.getElementById('sleepArchitectureChart'), {
    type: 'line',
    data: {
      labels: ['Newborn', '6 Months', '2 Years', '10 Years', '18 Years'],
      datasets: [
        {
          label: 'REM Sleep (%)',
          data: [50, 30, 25, 22, 20],
    ...
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'Changes in Sleep Architecture (REM vs. NREM) with Age'
        },
        tooltip: {
          mode: 'index',
          intersect: false
      ...
      scales: {
        y: {
          ...
          title: {
            display: true,
            text: 'Percentage of Total Sleep'
          }
        }
      }
    }
  ...
  // Chart 2: Adolescent Sleep Shift
  new Chart(document.getElementById('adolescentSleepShiftChart'), {
    type: 'line',
    data: {
      labels: ['8 PM', '9 PM', '10 PM', '11 PM', '12 AM', '1 AM', '2 AM'],
      datasets: [
        {
          label: 'Child (Age 10) Melatonin Release',
          data: [20, 60, 90, 80, 50, 20, 10],
          borderColor: '#f5a623',
        ...
        {
          label: 'Teenager (Age 16) Melatonin Release',
          data: [5, 10, 20, 60, 90, 80, 50],
          borderColor: '#bd10e0',
    ...
    options: {
      responsive: true,
      maintainAspectRatio: false,
      plugins: { title: { display: true, text: 'Adolescent Circadian Rhythm Shift (Melatonin Onset)' } },
      scales: { y: { title: { display: true, text: 'Relative Melatonin Level' } } }
    }
  });

  // Chart 2: Wake Windows by Age
  new Chart(document.getElementById('wakeWindowsChart'), {
    type: 'bar',
    data: {
      labels: ['1 Month', '4 Months', '6 Months', '9 Months', '12 Months', '18 Months'],
      datasets: [
        {
          label: 'Maximum Wake Window (Hours)',
          data: [1, 2, 2.5, 3, 4, 6],
    ...
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'Typical Maximum Wake Windows by Age'
        },
        legend: {
            display: false
        }
