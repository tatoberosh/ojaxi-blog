...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="neighbornavChart2"></canvas>
 </div>

## The Neighborhood Navigation Protocol: Four Stages of Development
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="neighbornavChart1"></canvas>
</div>
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="neighbornavChart3"></canvas>
</div>
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="neighbornavChart4"></canvas>
</div>
...
## The PATH Framework: Neighborhood Navigation Protocol Steps

The steps of the PATH framework guide families in establishing stable, healthy boundaries.
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="neighbornavChart5"></canvas>
</div>
...
Next week, we explore the "Keyholder Responsibility Protocol: Managing Home Access" and examine how this framework builds practical life-ready skills.

<script>
document.addEventListener('DOMContentLoaded', function() {
  // Chart 1: Skill Development
  new Chart(document.getElementById('neighbornavChart1'), {
    type: 'bar',
    data: {
  ...
  // Chart 2: Barriers
  new Chart(document.getElementById('neighbornavChart2'), {
    type: 'doughnut',
    data: {
  ...
  new Chart(document.getElementById('neighbornavChart3'), {
    type: 'line',
    data: {
  ...
  new Chart(document.getElementById('neighbornavChart4'), {
    type: 'bar',
    data: {
  ...
  new Chart(document.getElementById('neighbornavChart5'), {
    type: 'radar',
    data: {
      labels: ['P', 'A', 'T', 'H'],
      datasets: [{
        label: 'PATH Framework Skill Distribution',
        data: [90, 85, 82, 88],
    ...
    options: {
      responsive: true,
      plugins: {
        title: { display: true, text: 'PATH Framework Elements' }
      },
