...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="publictransitChart2"></canvas>
 </div>

## The Public Transit Competence Protocol: Four Stages of Development
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="publictransitChart1"></canvas>
</div>
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="publictransitChart3"></canvas>
</div>
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="publictransitChart4"></canvas>
</div>
...
## The RIDE Framework: Public Transit Competence Protocol Steps

The steps of the RIDE framework guide families in establishing stable, healthy boundaries.
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="publictransitChart5"></canvas>
</div>
...
Next week, we explore the "Home Alone Competence Protocol: Managing Safety Blocks" and examine how this framework builds practical life-ready skills.

<script>
document.addEventListener('DOMContentLoaded', function() {
  // Chart 1: Skill Development
  new Chart(document.getElementById('publictransitChart1'), {
    type: 'bar',
    data: {
  ...
  // Chart 2: Barriers
  new Chart(document.getElementById('publictransitChart2'), {
    type: 'doughnut',
    data: {
  ...
  new Chart(document.getElementById('publictransitChart3'), {
    type: 'line',
    data: {
  ...
  new Chart(document.getElementById('publictransitChart4'), {
    type: 'bar',
    data: {
  ...
  new Chart(document.getElementById('publictransitChart5'), {
    type: 'radar',
    data: {
      labels: ['R', 'I', 'D', 'E'],
      datasets: [{
        label: 'RIDE Framework Skill Distribution',
        data: [90, 85, 82, 88],
    ...
    options: {
      responsive: true,
      plugins: {
        title: { display: true, text: 'RIDE Framework Elements' }
      },
