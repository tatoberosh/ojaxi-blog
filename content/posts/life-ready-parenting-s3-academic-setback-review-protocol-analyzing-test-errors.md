...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="academicksetbackChart2"></canvas>
 </div>

## The Academic Setback Review Protocol: Four Stages of Development
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="academicksetbackChart1"></canvas>
</div>
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="academicksetbackChart3"></canvas>
</div>
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="academicksetbackChart4"></canvas>
</div>
...
## The TEST Framework: Academic Setback Review Protocol Steps

The steps of the TEST framework guide families in establishing stable, healthy boundaries.
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="academicksetbackChart5"></canvas>
</div>
...
Next week, we explore the "Strategy Modification Protocol: Pivoting Post-Failure" and examine how this framework builds practical life-ready skills.

<script>
document.addEventListener('DOMContentLoaded', function() {
  // Chart 1: Skill Development
  new Chart(document.getElementById('academicksetbackChart1'), {
    type: 'bar',
    data: {
  ...
  // Chart 2: Barriers
  new Chart(document.getElementById('academicksetbackChart2'), {
    type: 'doughnut',
    data: {
  ...
  new Chart(document.getElementById('academicksetbackChart3'), {
    type: 'line',
    data: {
  ...
  new Chart(document.getElementById('academicksetbackChart4'), {
    type: 'bar',
    data: {
  ...
  new Chart(document.getElementById('academicksetbackChart5'), {
    type: 'radar',
    data: {
      labels: ['T', 'E', 'S', 'T'],
      datasets: [{
        label: 'TEST Framework Skill Distribution',
        data: [90, 85, 82, 88],
    ...
    options: {
      responsive: true,
      plugins: {
        title: { display: true, text: 'TEST Framework Elements' }
      },
