...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="resilienceCurveChart"></canvas>
</div>
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="goalHorizonChart"></canvas>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
  new Chart(document.getElementById('resilienceCurveChart'), {
    type: 'line',
    data: {
      labels: ['Goal 1', 'Fail 1', 'Recover 1', 'Goal 2', 'Fail 2', 'Recover 2', 'Goal 3', 'Succeed 3'],
      datasets: [{
        label: 'Resilience Score',
        data: [10, 8, 12, 12, 10, 14, 14, 16],
        borderColor: '#4a90e2',
        fill: false
      }]
    },
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'The Resilience Curve: Growing Through Failure'
        }
      },
      scales: {
        y: {
  ...
  new Chart(document.getElementById('goalHorizonChart'), {
    type: 'bubble',
    data: {
      datasets: [{
        label: 'Ages 4-6',
    ...
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'The Goal Horizon: Goal Length and Complexity by Age'
        }
      },
      scales: {
        x: {
