---
title: "Screen Time: The Double-Edged Sword Your Child Wields Every Day"
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="negativeEffectsChart"></canvas>
</div>

<script>
document.addEventListener('DOMContentLoaded', function() {
  new Chart(document.getElementById('negativeEffectsChart'), {
    type: 'polarArea',
    data: {
      labels: ['Language Delay Risk', 'Anxiety/Depression Risk', 'Sleep Problems', 'Obesity Risk', 'Attention Issues'],
      datasets: [{
        label: 'Increased Risk Factor',
        data: [8, 9, 7, 6, 8],
        backgroundColor: [
          'rgba(255, 99, 132, 0.5)',
          'rgba(54, 162, 235, 0.5)',
    ...
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'The Creeping Costs of Unchecked Screen Time'
        }
      }
    }
  });
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="positiveEffectsChart"></canvas>
</div>

<script>
document.addEventListener('DOMContentLoaded', function() {
  new Chart(document.getElementById('positiveEffectsChart'), {
    type: 'radar',
    data: {
      labels: ['Problem Solving', 'Creativity', 'Digital Literacy', 'Social Skills', 'Cognitive Flexibility'],
      datasets: [{
        label: 'Skills Gained from Quality Screen Time',
        data: [8, 9, 7, 6, 8],
    ...
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'The Digital Skill Tree: Level Up Your Child\'s Future'
        }
      }
    }
  });
