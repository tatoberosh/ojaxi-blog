...
draft: false
description: "A data-driven approach to understanding how fears develop in children, tracking avoidance behaviors, and implementing systematic exposure therapy for lasting change."
categories: ["Child Development", "Data-Driven Parenting", "Health & Wellbeing"]
tags: ["fears", "phobias", "child psychology", "anxiety", "exposure therapy", "behavioral interventions", "parenting strategies"]
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="fearLoopChart"></canvas>
</div>
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="fearInventoryChart"></canvas>
</div>
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="avoidanceCurveChart"></canvas>
</div>
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="exposureHierarchyChart"></canvas>
</div>
...
<div style="height: 400px; margin: 2rem 0;">
  <canvas id="fearJournalChart"></canvas>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  new Chart(document.getElementById('fearLoopChart'), {
    type: 'radar',
    data: {
      labels: ['Trigger', 'Physical Response', 'Emotional Response', 'Avoidance', 'Reinforcement'],
      datasets: [{
        label: 'Fear Feedback Loop Intensity (1-10)',
        data: [7, 8, 9, 9, 8],
        borderColor: '#d0021b',
    ...
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'Fear Feedback Loop Components'
        }
      },
      scales: {
        r: {
  ...
  // Chart 2: Fear Inventory
  new Chart(document.getElementById('fearInventoryChart'), {
    type: 'bar',
    data: {
      labels: ['High-Frequency', 'Moderate-Frequency', 'Low-Frequency'],
      datasets: [{
    ...
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'Fear Trigger Frequency Distribution'
        }
      },
      scales: {
        y: {
          beginAtZero: true,
          title: { display: true, text: 'Number of Triggers' }
        }
      }
    }
  });

  // Chart 3: Avoidance Curve
  new Chart(document.getElementById('avoidanceCurveChart'), {
    type: 'line',
    data: {
      labels: ['Week 1', 'Week 4', 'Week 8', 'Week 12', 'Week 16', 'Week 20'],
      datasets: [{
        label: 'Avoidance Frequency (1-10)',
        data: [9, 8.5, 8, 6, 4, 2],
        borderColor: '#f5a623',
    ...
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'Avoidance Behavior Over Time'
        }
      },
      scales: {
        y: {
          beginAtZero: true,
          max: 10,
          title: { display: true, text: 'Avoidance Frequency' }
        }
      }
    }
  });

  // Chart 4: Exposure Hierarchy
  new Chart(document.getElementById('exposureHierarchyChart'), {
    type: 'bar',
    data: {
      labels: ['Step 1', 'Step 2', 'Step 3', 'Step 4', 'Step 5', 'Step 6', 'Step 7', 'Step 8'],
      datasets: [{
        label: 'Initial SUDS Rating (1-10)',
    ...
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'Fear Hierarchy: Steps Toward Exposure'
        }
      },
      scales: {
        y: {
          beginAtZero: true,
          max: 10,
          title: { display: true, text: 'Fear Level' }
        }
      }
    }
  });

  // Chart 5: Weekly Progress
  new Chart(document.getElementById('weeklyProgressChart'), {
    ...
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'Exposure Progress Over Time'
        }
      },
      scales: {
        y: {
  ...
  // Chart 6: Fear Journal
  new Chart(document.getElementById('fearJournalChart'), {
    type: 'doughnut',
    data: {
      labels: ['SUDS Decrease', 'Avoidance Reduction', 'Behavioral Improvements', 'Generalization'],
      datasets: [{
        data: [40, 25, 20, 15],
    ...
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'Components of Fear Reduction Success'
        },
